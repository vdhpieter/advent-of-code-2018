...
two_times_same_letter = 0
three_times_same_letter = 0

CSV.foreach('input/day2.csv', headers: false) do |row|
  result = {}
  string = row[0]
  ...
  two_times_same_letter += 1 if result.has_value?(2)
  three_times_same_letter += 1 if result.has_value?(3)
end

p "The checksum is: #{two_times_same_letter * three_times_same_letter}"
